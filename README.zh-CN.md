...
<p align="center">
  <strong>一只温暖、灵动、会陪 Codex 一起工作的水豚噜噜。</strong><br>
  丝滑静止循环 · 9 个任务状态 · 16 向注视 · 全部源帧公开
</p>
...
<p align="center">
  ...
  <img alt="83 source frames" src="https://img.shields.io/badge/源帧-83-f2a65a?style=flat-square">
  <img alt="16 look directions" src="https://img.shields.io/badge/注视方向-16-79a857?style=flat-square">
  <img alt="Apache 2.0 license" src="https://img.shields.io/badge/许可证-Apache--2.0-4c2a16?style=flat-square">
</p>
...
README 中的 GIF 和动作总览图均使用纯白背景，确保在 GitHub 上显示一致；83 张独立源帧与实际安装图集仍保留原始透明通道。
