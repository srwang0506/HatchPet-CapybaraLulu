...
实际安装的 `pet/spritesheet.webp` 是一张带时间轴的 8 × 11 动态图集。每个原生状态都有 20 个同步时间相位，全局循环为 1.20 秒，用 WebP 自身的图像时钟解决桌面渲染器切换图集列较慢造成的长时间停顿。15 个具名视觉动作片段被分配到 9 个真实 Codex 触发状态中；仓库同时保留静态图集，供质量检查、二次编辑和减少动态效果时使用。
...
<p>
  ...
  <sub><code>idle</code> · 20 相位 · 1.20 秒</sub><br><br>
...
<p>
  ...
  <sub><code>running-right</code> · 20 相位 · 1.20 秒</sub><br><br>
  向屏幕右侧拖动悬浮桌宠时出现。<br>
...
<p>
  ...
  <sub><code>running-left</code> · 20 相位 · 1.20 秒</sub><br><br>
  向屏幕左侧拖动悬浮桌宠时出现。<br>
...
<p>
  ...
  <sub><code>waving</code> · 20 相位 · 1.20 秒</sub><br><br>
  唤醒噜噜后，作为首次醒来问候出现。<br>
...
<p>
  ...
  <strong>✨ 跳跃</strong><br>
  <sub><code>jumping</code> · 20 相位 · 1.20 秒</sub><br><br>
  鼠标进入或悬停在噜噜上方时出现。<br>
...
<p>
  ...
  <sub><code>failed</code> · 20 相位 · 1.20 秒</sub><br><br>
...
<p>
  ...
  <sub><code>waiting</code> · 20 相位 · 1.20 秒</sub><br><br>
...
<p>
  ...
  <sub><code>running</code> · 20 个独立相位 · 1.20 秒</sub><br><br>
...
<p>
  ...
  <sub><code>review</code> · 20 相位 · 1.20 秒</sub><br><br>
