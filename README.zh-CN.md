...
<p>
  ...
  <sub><code>running-right</code> · 20 个独立相位 · 1.60 秒</sub><br><br>
  向屏幕右侧拖动悬浮桌宠时出现。完整两步循环会交替前后腿与相反方向摆动的手臂，不再出现像尾巴一样的后侧突起。<br>
...
<p>
  ...
  <sub><code>running-left</code> · 20 个独立相位 · 1.60 秒</sub><br><br>
...
两个方向都使用真正的 20 姿势两步循环，并由同一图像时间轴驱动。左跑逐帧镜像已通过检查的右跑，因此两边的节奏、身体锚点与落脚顺序完全对应。
...
<p align="center"><sub>同一套 20 相位时钟 · 严格逐帧镜像 · 相反屏幕方向</sub></p>
...
- 左右跑都包含 20 个独立姿势，左跑是已通过检查的右跑逐帧镜像，且相位顺序保持不变；
