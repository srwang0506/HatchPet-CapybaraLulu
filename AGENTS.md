...
- Directional running uses 20 distinct image-time poses for one complete two-step cycle. Approve the rightward anatomy first, then derive the leftward loop by framewise mirroring with phase order preserved; never introduce a tail-like rear bump, merged feet, or extra limbs.
